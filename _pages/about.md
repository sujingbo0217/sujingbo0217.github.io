...
I'm Jingbo (Bob) Su, currently a first-year PhD student in the <span style="color:green">College of William & Mary</span> [Department of Computer Science](https://www.wm.edu/as/computerscience/) under the supervision of my potential advisor Prof. [Bin Ren](https://www.cs.wm.edu/~bren/). I was a research assistant at <span style="color:blue">UC Riverside</span> [Parallel Algorithm Lab](https://pal.cs.ucr.edu) (PAL) with Prof. [Yihan Sun](https://www.cs.ucr.edu/~yihans) and Prof. [Yan Gu](https://www.cs.ucr.edu/~ygu). I earned my bachelor's degree in computer science and technology from <span style="color:purple">North China University of Technology</span>. I previously worked with Prof. Ruobin Wang and Dr. Lin Xu in the Evolutionary Algorithm Lab at NCUT. During my final year of undergraduate, I enrolled in the [Graduate Preparation Programs](https://gpp.ucr.edu/) at UCR and earned an advanced certificate in engineering.
